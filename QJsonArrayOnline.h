...
#define QJSON_LIST_TO_FILE \
    ...
    // QByteArray -> QList[]
    template<typename T>
    QList<T>& FromByteArray(const QByteArray& s, QList<T>& r)
    ...
    // QFile -> QList[]
    template<typename T>
    QList<T>& FromFile(QFile& f, QList<T>& r)
        QJSON_FILE_TO_LIST;
    ...
    // QByteArray -> QList[][]
    template<typename T>
    QList<QList<T>>& FromByteArray(const QByteArray& s, QList<QList<T>>& r)
        QJSON_BYTEARRAY_TO_LIST;
    ...
    // QFile -> QList[][]
    template<typename T>
    QList<QList<T>>& FromFile(QFile& f, QList<QList<T>>& r)
        QJSON_FILE_TO_LIST;
    ...
    // QByteArray -> QList[][][]
    template<typename T>
    QList<QList<QList<T>>>& FromByteArray(const QByteArray& s, QList<QList<QList<T>>>& r)
        QJSON_BYTEARRAY_TO_LIST;
    ...
    // QFile -> QList[][][]
    template<typename T>
    QList<QList<QList<T>>>& FromFile(QFile& f, QList<QList<QList<T>>>& r)
        QJSON_FILE_TO_LIST;
...
#define QJSON_VECTOR_TO_FILE QJSON_LIST_TO_FILE
    ...
    // QByteArray -> QVector[]
    template<typename T>
    QVector<T>& FromByteArray(const QByteArray& s, QVector<T>& r)
    ...
    // QFile -> QVector[]
    template<typename T>
    QVector<T>& FromFile(QFile& f, QVector<T>& r)
    ...
    // QByteArray -> QVector[][]
    template<typename T>
    QVector<QVector<T>>& FromByteArray(const QByteArray& s, QVector<QVector<T>>& r)
        QJSON_BYTEARRAY_TO_VECTOR;
    ...
    // QFile -> QVector[][]
    template<typename T>
    QVector<QVector<T>>& FromFile(QFile& f, QVector<QVector<T>>& r)
        QJSON_FILE_TO_VECTOR;
    ...
    // QByteArray -> QVector[][][]
    template<typename T>
    QVector<QVector<QVector<T>>>& FromByteArray(const QByteArray& s, QVector<QVector<QVector<T>>>& r)
        QJSON_BYTEARRAY_TO_VECTOR;
    ...
    // QFile -> QVector[][][]
    template<typename T>
    QVector<QVector<QVector<T>>>& FromFile(QFile& f, QVector<QVector<QVector<T>>>& r)
        QJSON_FILE_TO_VECTOR;
